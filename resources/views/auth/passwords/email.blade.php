                            ...
                            <div class="p-2">
                                ...
                                <form class="form-horizontal" method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="useremail" name="email" value="{{ old('email') }}" id="email">
                                        @error('email')
                                    ...
                                    <div class="mt-3 d-grid">
                                        <button class="btn btn-authentication w-md waves-effect waves-light" type="submit">Redefinir</button>
                                    </div>

            ...
            <div class="card">
                <div class="card-body">
                    <?php if(($createMode) or ($updateMode) or ($deleteMode) or ($showMode)): ?>
                        <?php echo $__env->make('livewire.submodules.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php else: ?>
                        <!-- Botoes -->
                        <div class="row">
                            <div class="col-12">
...
<?php $component = $__env->getContainer()->make(App\View\Components\Table::class, ['numCols' => 4,'colsNames' => $colsNames,'colsFields' => $colsFields,'colAcoes' => true,'colAcoesInfoAlert' => 'name','dados' => $dadosTabela] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH C:\Claudino Profissional\desenvolvimento\php\projetos_laravel\structure_model\resources\views/livewire/submodules/controller.blade.php ENDPATH**/ ?>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <?php if(($createMode) or ($updateMode) or ($deleteMode) or ($showMode)): ?>
                    <?php echo $__env->make('livewire.tools.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php else: ?>
                    <!-- Botoes -->
                        <div class="row">
                            <div class="col-12">
...
<?php /**PATH C:\Claudino Profissional\desenvolvimento\php\projetos_laravel\structure_model\resources\views/livewire/tools/controller.blade.php ENDPATH**/ ?>
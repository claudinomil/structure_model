...
return [
    ...
    "Main" => "Main",
    "Main_data_of_your_Profile" => "Main data of your Profile",
    ...
    "Search" => "Search...",
    "Mega_Menu" => "Mega Menu",
    "Menu_Vertical" => "Vertical Menu",
    "Menu_Horizontal" => "Horizontal Menu",
    "Menu_Vertical_Compact_Sidebar" => "Menu Vertical Compact Sidebar",
    "Menu_Vertical_Icon_Sidebar" => "Menu Vertical Icon Sidebar",
    "Menu_Vertical_Boxed" => "Menu Vertical Boxed",
    "Menu_Vertical_Scrollable" => "Menu Vertical Scrollable",
    "Menu_Horizontal_Boxed_Width" => "Menu Horizontal Boxed Width",
    "Menu_Horizontal_Scrollable" => "Menu Horizontal Scrollable",
    "Vertical" => "Vertical",
    "Horizontal" => "Horizontal",
    "Vertical_Compact_Sidebar" => "Vertical Compact Sidebar",
    "Vertical_Icon_Sidebar" => "Vertical Icon Sidebar",
    "Vertical_Boxed" => "Vertical Boxed",
    "Vertical_Scrollable" => "Vertical Scrollable",
    "Horizontal_Boxed_Width" => "Horizontal Boxed Width",
    "Horizontal_Scrollable" => "Horizontal Scrollable",
    "Simple" => "Simple",
    "Compact" => "Compact",
    "Icon" => "Icon",
    "Boxed" => "Boxed",
